...
//@Serializer(forClass = KTXInstant::class)
object KTXInstantSerializer : TemporalExtendedJsonSerializer<KTXInstant>() {
...
//@Serializer(forClass = KTXLocalDateTime::class)
...
//@Serializer(forClass = KTXLocalTime::class)
