 ...
 *
 */
class KFongoRule<T : Any>(val defaultDocumentClass: KClass<T>,
                          val generateRandomCollectionName: Boolean = false,
                          val dbName: String = FongoRule.randomName()) : TestRule {

    companion object {

        inline fun <reified T : Any> rule(generateRandomCollectionName: Boolean = false): KFongoRule<T>
                = KFongoRule(T::class, generateRandomCollectionName)
