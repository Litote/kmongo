...
import static org.bson.codecs.pojo.PojoBuilderHelper2.configureClassModelBuilder;
import static org.bson.codecs.pojo.PojoBuilderHelper2.stateNotNull;
...
final class ClassModelBuilder2<T> {
    ...
    private List<Convention2> conventions = emptyList();
    ...
    ClassModelBuilder2(final Class<T> type) {
     ...
     * @since 3.10
     */
    public ClassModelBuilder2<T> idGenerator(final IdGenerator<?> idGenerator) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> instanceCreatorFactory(final InstanceCreatorFactory<T> instanceCreatorFactory) {
     ...
     */
    public ClassModelBuilder2<T> type(final Class<T> type) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> conventions(final List<Convention2> conventions) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> annotations(final List<Annotation> annotations) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> discriminator(final String discriminator) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> discriminatorKey(final String discriminatorKey) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> enableDiscriminator(final boolean discriminatorEnabled) {
     ...
     * @return this
     */
    public ClassModelBuilder2<T> idPropertyName(final String idPropertyName) {
    ...
    public ClassModel<T> build() {
        ...
        for (Convention2 convention : conventions) {
    ...
    ClassModelBuilder2<T> propertyNameToTypeParameterMap(final Map<String, TypeParameterMap> propertyNameToTypeParameterMap) {
        this.propertyNameToTypeParameterMap = unmodifiableMap(new HashMap<String, TypeParameterMap>(propertyNameToTypeParameterMap));
        return this;
    }

    ClassModelBuilder2<T> addProperty(final PropertyModelBuilder<?> propertyModelBuilder) {
