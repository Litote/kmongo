...
import static org.bson.codecs.pojo.PropertyReflectionUtils2.getPropertyMethods;
import static org.bson.codecs.pojo.PropertyReflectionUtils2.isGetter;
import static org.bson.codecs.pojo.PropertyReflectionUtils2.toPropertyName;
...
final class PojoBuilderHelper2 {
    ...
    static <T> void configureClassModelBuilder(final ClassModelBuilder2<T> classModelBuilder, final Class<T> clazz) {
        ...
        while (!currentClass.isEnum() && currentClass.getSuperclass() != null) {
            ...
            PropertyReflectionUtils2.PropertyMethods propertyMethods = getPropertyMethods(currentClass);
