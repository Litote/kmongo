...
class SubData2_Col<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Collection<SubData2>?>) : NotAnnotatedData_Col<T>(previous,property) {
    ...
    override fun memberWithAdditionalPath(additionalPath: String): SubData2_<T> = SubData2_(this, customProperty(this, additionalPath))}

class SubData2_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, SubData2>?>) : NotAnnotatedData_Map<T, K>(previous,property) {
    val a1: KPropertyPath<T, Int?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.Int?>(this,SubData2::a1)
