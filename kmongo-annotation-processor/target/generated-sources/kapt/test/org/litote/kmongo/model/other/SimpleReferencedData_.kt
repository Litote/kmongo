...
class SimpleReferencedData_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, SimpleReferencedData?>) : KPropertyPath<T, SimpleReferencedData?>(previous,property) {
    val version: KPropertyPath<T, Int?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.Int?>(this,SimpleReferencedData::version)
    ...
    val labels: KMapSimplePropertyPath<T, Locale?, List<String>?>
        get() = org.litote.kmongo.property.KMapSimplePropertyPath<T, java.util.Locale?, kotlin.collections.List<kotlin.String>?>(this,SimpleReferencedData::labels)
    companion object {
...
class SimpleReferencedData_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, SimpleReferencedData>?>) : KMapPropertyPath<T, K, SimpleReferencedData?, SimpleReferencedData_<T>>(previous,property) {
    val version: KPropertyPath<T, Int?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.Int?>(this,SimpleReferencedData::version)
