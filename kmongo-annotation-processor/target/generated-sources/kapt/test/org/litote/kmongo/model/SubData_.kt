...
class SubData_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, SubData?>) : TestData_<T>(previous,property) {
    val s: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,org.litote.kmongo.property.findProperty<SubData,String?>("s"))
    companion object {
...
class SubData_Col<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Collection<SubData>?>) : TestData_Col<T>(previous,property) {
    ...
    override fun memberWithAdditionalPath(additionalPath: String): SubData_<T> = SubData_(this, customProperty(this, additionalPath))}

class SubData_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, SubData>?>) : TestData_Map<T, K>(previous,property) {
    val s: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,org.litote.kmongo.property.findProperty<SubData,String?>("s"))
