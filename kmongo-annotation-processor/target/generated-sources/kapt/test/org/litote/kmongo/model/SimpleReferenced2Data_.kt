...
class SimpleReferenced2Data_Col<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Collection<SimpleReferenced2Data>?>) : KPropertyPath<T, Collection<SimpleReferenced2Data>?>(previous,property) {
    val price: KProperty1<T, Double?>
        get() = org.litote.kmongo.property.KPropertyPath(this,SimpleReferenced2Data::price)
}
