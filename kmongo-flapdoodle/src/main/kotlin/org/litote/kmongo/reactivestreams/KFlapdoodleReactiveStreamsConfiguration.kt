 ...
 *
 */
internal class KFlapdoodleReactiveStreamsConfiguration(version: IFeatureAwareVersion = defaultMongoTestVersion) {

    val mongoClient: MongoClient by lazy {
        MongoClientProvider.createMongoClient(
            EmbeddedMongo(version).connectionString { host, command, callback ->
                MongoClientProvider
