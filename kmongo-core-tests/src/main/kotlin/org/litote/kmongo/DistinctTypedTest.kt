 ...
 *
 */
class DistinctTypedTest : AllCategoriesKMongoBaseTest<Friend>() {
    ...
    fun distinctOnStringEntities() {
        ...
        val l = col.distinct(Friend::address).toList()
    ...
    fun distinctOnIntegerEntities() {
        ...
        val l = col.distinct(Friend::coordinate / Coordinate::lat).toList()
        assertEquals(2, l.size)
    ...
    fun distinctOnTypedProperty() {
        ...
        val l = col.distinct(Friend::coordinate).toList()
        assertEquals(2, l.size)
    ...
    fun distinctWithQuery() {
        ...
        val l = col.distinct(Friend::coordinate, Friend::name ne "John").toList()
    ...
    fun distinctWithParameterizedQuery() {
        ...
        val l = col.distinct(Friend::coordinate, Friend::name eq "Peter").toList()
        assertEquals(1, l.size)
