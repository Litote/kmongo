 ...
 *
 */
class DistinctTest : KMongoRxBaseTest<Friend>() {
    ...
    fun distinctOnStringEntities() {
        col.insertMany(listOf(Friend("John", wallStreetAvenue),
                ...
                Friend("Peter", "24 Wall Street Avenue"))).blockingAwait()
    ...
    fun distinctOnIntegerEntities() {
        col.insertMany(listOf(Friend("John", Coordinate(1, 2)),
                ...
                Friend("Peter", Coordinate(125, 72)))).blockingAwait()
    ...
    fun distinctWithQuery() {
        col.insertMany(listOf(Friend("John", Coordinate(1, 2)),
                ...
                Friend(null, Coordinate(125, 72)))).blockingAwait()
    ...
    fun distinctWithParameterizedQuery() {
        col.insertMany(listOf(Friend("John", Coordinate(1, 2)),
                Friend("Peter", Coordinate(3, 4)))).blockingAwait()
