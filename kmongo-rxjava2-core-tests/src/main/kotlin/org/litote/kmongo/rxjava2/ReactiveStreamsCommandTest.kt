 ...
 *
 */
class ReactiveStreamsCommandTest : KMongoReactiveStreamsRxBaseTest<Friend>(oldestMongoTestVersion) {
    ...
    @Test
    fun canRunACommand() {
        val document = database.runCommand<Document>("{ ping: 1 }").blockingGet()
