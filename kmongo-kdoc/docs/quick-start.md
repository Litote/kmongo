...
*(Kotlin)* 
```kotlin
implementation("org.litote.kmongo:kmongo-async:4.2.1")
``` 
*(Groovy)* 
```groovy
implementation 'org.litote.kmongo:kmongo-async:4.2.1'
...
*(Kotlin)* 
```kotlin
implementation("org.litote.kmongo:kmongo-reactor:4.2.1")
``` 
*(Groovy)* 
```groovy
implementation 'org.litote.kmongo:kmongo-reactor:4.2.1'
...
*(Kotlin)* 
```kotlin
implementation("org.litote.kmongo:kmongo-rxjava2:4.2.1")
``` 
*(Groovy)* 
```groovy
implementation 'org.litote.kmongo:kmongo-rxjava2:4.2.1'
