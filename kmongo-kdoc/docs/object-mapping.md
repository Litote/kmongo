...
```
compile 'org.litote.kmongo:kmongo-id:3.12.1'
```
...
Starting with 3.12.1 version, KMongo also supports [Kotlinx Serialization](https://github.com/Kotlin/kotlinx.serialization) mapping.
